@if ($paginator->hasPages())
    <div class="join my-2 w-full justify-center">
            ...
            <button class="join-item btn btn-disabled" aria-disabled="true" aria-hidden="true" aria-label="@lang('pagination.previous')">«</button>
            @else
            ...
            @else
            <button
                class="join-item btn btn-disabled" aria-disabled="true" aria-hidden="true" aria-label="@lang('pagination.next')">»</button>
            @endif
    </div>
@endif
