<section class="space-y-6">
    ...
    <button class="btn btn-error" onclick="delete_user.showModal()">{{ __('Delete Account') }}</x-danger-button>
        ...
        <dialog name="confirm-user-deletion" id="delete_user" class="modal">
            <div class="modal-box">
                ...
                <div class="modal-action">
                    ...
                    <button type="submite" form="delete_user_form" class="btn btn-error" class="ms-3">
                        {{ __('Delete Account') }}
                    </button>
                </div>
            </div>
